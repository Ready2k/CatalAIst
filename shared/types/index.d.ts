...
export declare const SessionSchema: z.ZodObject<{
    ...
    status: "completed" | "active" | "manual_review" | "pending_admin_review";
    sessionId: string;
    initiativeId: string;
    modelUsed: string;
    createdAt: string;
...
export declare const AuditLogEntrySchema: z.ZodObject<{
    ...
    sessionId: string;
    timestamp: string;
    eventType: "input" | "rating" | "clarification" | "classification" | "feedback";
    userId: string;
    piiScrubbed: boolean;
    data?: any;
...
export declare const SessionFiltersSchema: z.ZodObject<{
    ...
    status?: "completed" | "active" | "manual_review" | undefined;
